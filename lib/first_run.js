...
var firstRun = {
  ...
  runFirstRun: function() {
    ...
    if (ls.getItem("Options:DissableButton") === void(0) || loadReason === "install") {
    ...
    if (ls.getItem("glyph_cells") === void(0) || loadReason === "install") {
    ...
    if (postingDomain === void(0) || postingDomain === null || loadReason === "install") {
